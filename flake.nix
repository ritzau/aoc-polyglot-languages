  ...
  outputs = { self, nixpkgs, flake-utils }:
    flake-utils.lib.eachDefaultSystem (system: 
      let 
        ...
        baseLib = base // { inherit buildFunctions; };
        
        # Import all language definitions
        languages = {
          c = import ./languages/c.nix { inherit pkgs; base = baseLib; };
          python = import ./languages/python.nix { inherit pkgs; base = baseLib; };
          rust = import ./languages/rust.nix { inherit pkgs; base = baseLib; };
          go = import ./languages/go.nix { inherit pkgs; base = baseLib; };
